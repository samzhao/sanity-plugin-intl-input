...
var defaultResolve__default = _interopDefault(defaultResolve);
...
var ConfirmDelete = _interopDefault(require('@sanity/desk-tool/lib/components/ConfirmDelete'));
var TrashIcon = _interopDefault(require('part:@sanity/base/trash-icon'));
...
var PublishWithi18nAction = function PublishWithi18nAction(props) {
  ...
  var syncState = reactHooks.useSyncState(props.id, props.type);
  ...
  return {
    ...
    onHandle: function () {
      var _onHandle = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                return client.patch(((_props$draft = props.draft) === null || _props$draft === void 0 ? void 0 : _props$draft._id) || props.id, {
                  set: _defineProperty({}, fieldName, languageId)
                }).commit();

              case 12:
                publish.execute();
                _context.next = 15;
                return client.fetch("*[_id match path($id)]", {
...
var DeleteWithi18nAction = function DeleteWithi18nAction(props) {
  ...
  return {
    ...
    dialog: isConfirmDialogOpen && {
      ...
      title: "Delete",
      content: /*#__PURE__*/React__default.createElement(ConfirmDelete, {
        draft: props.draft,
...
var index = (function (props) {
  ...
  var actions = defaultResolve__default(props).map(function (Action) {
